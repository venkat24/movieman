...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "Movie Poster not Available", None))
        self.pushButton.setText(_translate("Form", "Search", None))
        self.label_3.setText(_translate("Form", "Movies Loaded", None))
        self.pushButton_8.setText(_translate("Form", "Load Movie", None))
